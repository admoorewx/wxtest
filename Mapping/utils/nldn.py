...
# Mesh file info
mrms_url = 'https://mrms.ncep.noaa.gov/data/2D/NLDN_CG_005min_AvgDensity/MRMS_NLDN_CG_005min_AvgDensity.latest.grib2.gz'
mrms_file = 'MRMS_NLDN_CG_005min_AvgDensity.latest.grib2'
########################################################################################################################
...
########################################################################################################################
def add_data(ax,mesh_url,mesh_file,savedir,region):
...
ax = add_data(ax, mrms_url, mrms_file, saveDir,region)
ax.set_extent(region, crs=ccrs.PlateCarree())
plt.savefig(os.path.join(saveDir,"nldn_5min_latest.png"), bbox_inches='tight', pad_inches=0, transparent=True)