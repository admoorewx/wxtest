...
def main():
    ...
    ax.imshow(dat,
              ...
              extent=(ds.variables['lon'][:].min(), ds.variables['lon'][:].max(), ds.variables['lat'][:].min(), ds.variables['lat'][:].max()),
              zorder=9,
              alpha=0.35)
    ...
    plt.savefig(saveDir+"splains_basemosiac_"+radar_date+".png", bbox_inches='tight', pad_inches=0)
